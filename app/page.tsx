          ...
          <div className="container-page">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div className="lg:col-span-1">
                <div className="flex items-center gap-2.5 mb-4">
                  <Image src="/logo.png" alt="Miss Kurochka" width={44} height={44} className="rounded-lg" />
                  <h3 className="text-xl font-black">{t('footer.title')}</h3>
                </div>
                <p className="text-sm text-white/60 leading-relaxed mb-5">
                  Самая вкусная курочка в Бишкеке. Свежие ингредиенты, фирменные рецепты, быстрая доставка.
                </p>
                <div className="flex gap-2">
                  {[
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-lg bg-white/5 hover:bg-[var(--brand)] flex items-center justify-center transition"
                      aria-label={s.label}
                    >
                      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                        <path d={s.svg} />
              ...
              {/* Меню */}
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-white/50 mb-4">Меню</h4>
                <ul className="space-y-2.5">
                  <li><button onClick={() => scrollToSection('combo')} className="text-sm text-white/80 hover:text-[var(--brand-light)] transition">Комбо</button></li>
                  <li><button onClick={() => scrollToSection('popular')} className="text-sm text-white/80 hover:text-[var(--brand-light)] transition">Хиты продаж</button></li>
                  <li><button onClick={() => scrollToSection('about')} className="text-sm text-white/80 hover:text-[var(--brand-light)] transition">О нас</button></li>
                  <li><button onClick={() => session ? router.push('/menu') : setShowAuthModal(true)} className="text-sm text-white/80 hover:text-[var(--brand-light)] transition">Полное меню</button></li>
                </ul>
              </div>

              {/* Контакты */}
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-white/50 mb-4">Контакты</h4>
                <ul className="space-y-3">
                  <li>
                    <a href="tel:+996555123456" className="flex items-center gap-2 text-sm text-white/80 hover:text-[var(--brand-light)] transition">
                  ...
                  <li className="flex items-start gap-2 text-sm text-white/60">
                    ...
                    <span>{branches[0]?.address ?? 'Бишкек, Кыргызстан'}</span>
                  </li>
              ...
              {/* Доставка */}
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-white/50 mb-4">Доставка</h4>
                <ul className="space-y-3 text-sm text-white/60 mb-5">
                  <li className="flex items-start gap-2">
                    <Truck className="w-4 h-4 shrink-0 mt-0.5 text-[var(--brand-light)]" />
                    Доставка от 30 минут
                  </li>
                  <li className="flex items-start gap-2">
                    <ShieldCheck className="w-4 h-4 shrink-0 mt-0.5 text-[var(--brand-light)]" />
                    Безопасная оплата
                  </li>
                  <li className="flex items-start gap-2">
                    <Award className="w-4 h-4 shrink-0 mt-0.5 text-[var(--brand-light)]" />
                    Возврат при браке
                  </li>
                </ul>
                <button
            ...
            <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <div className="flex gap-5">
                <a href="#" className="text-xs text-white/40 hover:text-white/70 transition">Политика конфиденциальности</a>
                <a href="#" className="text-xs text-white/40 hover:text-white/70 transition">Условия использования</a>
              </div>
            </div>
          </div>
        </footer>
